...
const TITLE = "Urbont — Safe, Affordable Limousine Service in Miami & Florida";
const DESCRIPTION =
...
export const metadata: Metadata = {
  ...
  keywords: [
    "ridesharing Miami",
    "ride hailing Florida",
    "uber alternative Miami",
    "driver jobs Miami",
    "valet service Miami",
    "taxi app Miami",
    "car service Miami",
  ...
  openGraph: {
    ...
    url: SITE + "/",
    siteName: "Urbont",
    title: "Urbont — Safe, Affordable Limousine Service in Miami",
    description:
