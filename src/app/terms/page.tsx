...
import React from "react";
  ...
  const SECTIONS = [
    ...
    },
    {
      ...
      content: [
        "By creating an Urbont account or submitting any signup form, you agree to receive SMS (text message) communications from Urbont Technologies Inc. to the mobile number you provide. The following terms govern our SMS program:",
        "**Program name:** Urbont Notifications",
        "**Message types:**",
        "• Transactional SMS: trip confirmations, driver arrival alerts, OTP verification codes, payment receipts, and account security alerts.",
        "• Safety SMS: real-time safety notifications and emergency-related communications.",
        "• Promotional SMS (only with separate explicit opt-in): special offers, new features, and city launch announcements.",
        "**Message frequency:** Transactional messages are sent as events occur. Promotional messages are sent no more than 4 times per month.",
        "**Message and data rates:** Standard message and data rates from your wireless carrier may apply. Urbont does not charge a fee for SMS messages.",
        "**Opt-in:** You provide your consent to receive transactional and safety SMS by submitting your phone number and agreeing to these Terms. Promotional SMS requires a separate opt-in.",
        "**Opt-out:** Reply STOP to any Urbont text message to unsubscribe from promotional messages. You will receive a single confirmation. To opt out of all non-critical SMS, contact privacy@urbont.com with subject 'SMS OPT-OUT'. Opting out does not affect transactional or safety messages needed to deliver the Service.",
        "**Help:** Reply HELP to any message or email privacy@urbont.com for assistance.",
        "**No third-party sharing:** No mobile phone number information or SMS consent data will be shared with third parties or affiliates for marketing, promotional, or any other purposes not described in our Privacy Policy.",
        "**Carriers:** Urbont SMS is compatible with all major US wireless carriers. Carrier support and message delivery are not guaranteed and may vary.",
        "For complete information about our SMS practices, please review our Privacy Policy at urbont.com/privacy.",
      ],
    },
    {
          ...
          <div className="container mx-auto px-4 md:px-6 max-w-3xl">
            ...
            <div className="mt-16 p-6 bg-primary/5 rounded-2xl border border-primary/20">
              <p className="text-sm text-gray-600 leading-relaxed">
                ...
                <a href="mailto:legal@urbont.com" className="text-primary font-semibold hover:underline">
                  legal@urbont.com
                </a>.
              </p>
            </div>
